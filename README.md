...
<b>🛠 Features</b><br>
<ul>
  <li>✅ Interactive UI with four colored buttons</li>
  <li>✅ Dynamic difficulty increase with each correct sequence</li>
...
<b>📌 How to Play?</b><br>
<ul>
 <li>1️⃣ Press any key to start the game.</li>
 <li>2️⃣ Follow the pattern of flashing buttons.</li>
 <li>3️⃣ Click the buttons in the same order as shown.</li>
...
<ul>
 <li>✨ Add sound effects for button clicks</li>
 <li>✨ Implement a difficulty mode (Easy, Medium, Hard)</li>
 <li>✨ Create a leaderboard to track the highest scores</li>
</ul>
